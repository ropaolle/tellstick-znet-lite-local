...
const devices = {
  2: { id: 2, methods: 19, name: 'Zwave', state: 2, statevalue: 64, type: 'device', favorite: true },
  1000: { id: 1000, methods: 3, name: 'Zwave', state: 1, statevalue: 64, type: 'device', favorite: false },
  1001: { id: 1001, methods: 19, name: 'Zwave', state: 2, statevalue: 64, type: 'device' },
};

const sensors = {
  21: { id: 21, type: 'sensor', battery: 222, favorite: true, temp: '23', lum: '22', humidity: '2.0' },
  22: { id: 22, type: 'sensor', battery: 222, favorite: false, temp: '23', lum: '22', humidity: '2.0' },
};
...
test('Devices run methods', () => {
  const wrapper = shallow(<DeviceTable devices={devices} sensors={sensors} handleUpdateDevice={() => {}} />);
});
